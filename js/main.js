...
/*************************************************************************************
Variable x is a local variable becuause it is inisde of a function.  Variable y is not a global, it is also local bc it is also inside of a function.
console.log(y) prints undefined becuase var y is isolated in a function.  When you console.log(x) it prints "I'm a local vaiable" bc the function scopeThis is nested inside of the function that contains var x.
**************************************************************************************/
...
/*************************************************************************************
------------ ANSWER -------------------
There is no y variable, so that would be undefined
the x variable is also no defined until after the console log, so that would also come back undeined.
**************************************************************************************/
...
/**************************************************************************************
------------ ANSWER -------------------
the console.log inside the IFEE prints 4.  The console.log(add) outside the IFEE should return an error undefined becuase its outside the function.
**************************************************************************************/
